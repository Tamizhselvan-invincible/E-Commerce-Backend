...
public class CustomerController {
	...
	public ResponseEntity<List<Customer>> getAllCustomersHandler(@RequestHeader String token){
	...
	public ResponseEntity<Customer> getLoggedInCustomerDetailsHandler(@RequestHeader String token){
	...
	@PutMapping("/customer")
	public ResponseEntity<Customer> updateCustomerHandler(@Valid @RequestBody CustomerUpdateDTO customerUpdate, @RequestHeader String token){
	...
	public ResponseEntity<Customer> updateCustomerMobileEmailHandler(@Valid @RequestBody CustomerUpdateDTO customerUpdate, @RequestHeader String token){
	...
	public ResponseEntity<SessionDTO> updateCustomerPasswordHandler(@Valid @RequestBody CustomerDTO customerDto, @RequestHeader String token){		
	...
	public ResponseEntity<Customer> updateAddressHandler(@Valid @RequestBody Address address, @RequestParam String type, @RequestHeader String token){
	...
	public ResponseEntity<Customer> updateCreditCardHandler(@RequestHeader String token, @Valid @RequestBody CreditCard newCard){
	...
	public ResponseEntity<Customer> deleteAddressHandler(@RequestParam String type, @RequestHeader String token){
		return new ResponseEntity<>(customerService.deleteAddress(type, token), HttpStatus.ACCEPTED);
	}
	
	// Handler to delete customer
	@DeleteMapping("/customer")
	public ResponseEntity<SessionDTO> deleteCustomerHandler(@Valid @RequestBody CustomerDTO customerDto, @RequestHeader String token){
	...
	public ResponseEntity<List<Order>> getCustomerOrdersHandler(@RequestHeader String token){
